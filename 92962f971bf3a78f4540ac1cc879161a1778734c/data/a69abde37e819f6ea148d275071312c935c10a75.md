...
- Name: suite/e2e/dashboard/member-detail.journey.spec.ts >> Settings — team member detail >> renders a member’s details (Basics + Address)
- Location: suite/e2e/dashboard/member-detail.journey.spec.ts:26:7
